...
data_vid_id = "datasets/SoccerNet/raw_videos/{}.mkv"

# dataset_path: path to dataset
dataset_path = "./datasets/SoccerNet/"
# annotations downloaded from official downstream dataset
# json_path = "./datasets/SoccerNet/MSRVTT_data.json"
# train_csv = "./datasets/SoccerNet/MSRVTT_train.9k.csv"
# test_csv = "./datasets/SoccerNet/MSRVTT_JSFUSION_test.csv"

# To generate tsv files:
# {}.img.tsv: we use it to store video path info 
visual_file = "./datasets/SoccerNet/{}.img.split-000.tsv"
# {}.caption.tsv: we use it to store  captions
cap_file = "./datasets/SoccerNet/{}.caption.split-000.tsv"
...
linelist_file = "./datasets/SoccerNet/{}.linelist.tsv"
...
label_file = "./datasets/SoccerNet/{}.label.split-000.tsv"
...
def dump_tsv_gt_to_coco_format(caption_tsv_file, outfile):
    ...
    for cap_row  in tqdm(caption_tsv):
        image_id = cap_row[0]
        key = image_id
