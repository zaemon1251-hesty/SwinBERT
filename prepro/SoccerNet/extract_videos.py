...
class Stage2:
    ...
    def run(self):
        ...
        for data in self.data:
            ...
            extract_video_args.append((src_video_path, dst_video_path, spotTime))
        ...
        invalid_data.to_csv(invalid_data_file, index=False, header=False, sep="\t")

    def extract_video(
        self, src_video_path: str, dst_video_path: str, spotTime: int | float
    ):
        import subprocess
